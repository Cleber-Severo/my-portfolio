export const ptBrTransaction = {
  translation: {
    ...
    hero: {
      ...
      description:
        'Desenvolvedor de software com experiência em criar soluções ágeis e escaláveis que transformam ideias em resultados.',
      welcome: 'Seja Bem-vindo ao meu portfólio',
      contactBtn: 'Contato',
    },
    projects: {
      title: 'Projetos',
      cards: {
        meteora: 'Loja virtual interativa',
        pokedex: 'Pokedex com tipos e evoluções',
        expensesControl: 'Aplicação de controle financeiro',
        adoPet: 'Site de Adoção de Pets',
      },
    },
    experiences: {
      title: 'Experiência',
